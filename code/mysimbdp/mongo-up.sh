...
sleep 15
echo "Sharding ENABLED for 'airbnb' DB and 'reviews' collections using 'hashed'."

# shard cluster distribution command -
# docker exec -it mongo-router /bin/bash -c "/usr/bin/mongosh --port 27017 db.reviews.getShardDistribution()"
